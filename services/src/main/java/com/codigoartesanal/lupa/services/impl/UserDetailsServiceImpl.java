...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(final String username)
        ...
        com.codigoartesanal.lupa.model.User user = userRepository.findByUsername(username);
    ...
    private User buildUserForAuthentication(com.codigoartesanal.lupa.model.User user,
                                            List<GrantedAuthority> authorities) {
